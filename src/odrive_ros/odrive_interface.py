...
class ODriveInterfaceAPI(object):
    ...
    def left_vel_estimate(self):  return self.left_axis.encoder.vel_estimate   if self.left_axis  else 0 # units: turn/s
    ...
    def left_pos(self):           return self.left_axis.encoder.pos_cpr        if self.left_axis  else 0  # units: turn
    ...
    def right_temperature(self):  return self.right_axis.fet_thermistor.temperature if self.right_axis else 0. #axis.motor.get_inverter_temp()
